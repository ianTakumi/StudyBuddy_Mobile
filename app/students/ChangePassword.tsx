      ...
      >
        ...
        >
          <View className="py-6">
            ...
            <View
              className="bg-emerald-50 rounded-3xl p-5 mb-6 relative overflow-hidden"
              style={{
                shadowColor: "#10B981",
                shadowOffset: { width: 0, height: 4 },
                shadowOpacity: 0.1,
            ...
            >
              <View className="absolute -top-4 -right-4 w-14 h-14 bg-emerald-100 rounded-full opacity-50" />
